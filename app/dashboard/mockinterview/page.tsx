      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div>
          <Sheet>
            ...
            <SheetContent className="w-full overflow-y-auto bg-white">
              <SheetHeader>
                <SheetTitle className="text-2xl font-bold text-black">Set Up Your Interview</SheetTitle>
                <SheetDescription>
  ...
  return (
    <div className="flex justify-between items-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
      ...
      <div className="flex space-x-2">
        <Button onClick={() => {
          handleDelete()
        }} variant="ghost" size="icon" className="bg-red">
        ...
        <Button onClick={() => {
          router.push(`/dashboard/interview/${mockId}`)
        }} variant="ghost" size="icon" className="bg-blue-500">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-5 h-5 text-white">
